...
import { accountActivation, signup, login, forgotPassword, resetPassword, googleLogin, facebookLogin } from '../actions/auth'
import { runValidation } from './../validators/index';
import { userSignupValidator, userLoginValidator, resetPasswordValidator, forgotPasswordValidator } from './../validators/auth';
...
authRouter.put('/forgot-password', forgotPasswordValidator, runValidation, forgotPassword)
